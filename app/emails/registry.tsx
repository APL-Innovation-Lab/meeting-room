...
export const emailRegistry = {
    meetingAwaiting: { component: MeetingRoomAwaitingEmail, subject: "Meeting Room - Awaiting Confirmation" },
    meetingCanceled: { component: MeetingRoomCancellationEmail, subject: "Meeting Room - Canceled" },
    meetingConfirmed: { component: MeetingRoomConfirmationEmail, subject: "Meeting Room - Confirmed" },
    sharedCanceled: { component: SharedLearningRoomCancellationEmail, subject: "Shared Learning Room - Canceled" },
    sharedConfirmed: { component: SharedLearningRoomConfirmationEmail, subject: "Shared Learning Room - Confirmed" },
